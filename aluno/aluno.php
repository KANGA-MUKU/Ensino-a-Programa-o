            ...
            <div class="row">
              ...
              <div class="card mb-3" style="max-width: 18rem;" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <a href="../professores/logica.php"><button type="button" class="btn btn-outline-dark">Começar</button></a>
                </div>
              </div> 
              ...
              <div class="card text-bg-primary mb-3" style="max-width: 18rem;" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <a href="../professores/c++.php"><button type="button" class="btn btn-outline-dark">Começar</button></a>
                </div>
              </div> 
              ...
              <div class="card  mb-3 " style="max-width: 18rem; background-color: orange; color: white;" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  <a href="../professores/html.php"><button type="button" class="btn btn-outline-dark">Começar</button></a>
                </div>
              </div> 
              ...
              <div class="card text-bg-warning mb-3" style="max-width: 18rem; color: white !important;" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  <a href="../professores/Java.php"><button type="button" class="btn btn-outline-dark">Começar</button></a>
                </div>
              </div> 
              ...
              <div class="card text-bg-light mb-3" style="max-width: 18rem;" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  <a href="../professores/php.php"><button type="button" class="btn btn-outline-dark">Começar</button></a>
                </div>
              </div> 
